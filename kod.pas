...
begin
  ...
  writeln('Сортировка по возрастанию пузырьковым- 1');
  writeln('Сортировка по убыванию пузырьковым- 2');
  writeln('Сортировка по возрастанию быстрым- 3');
  writeln('Сортировка по убыванию быстрым- 4');
  writeln('Выход- 0');
  readln(a);
  case a of
    1:
      begin
        ...
        writeln('Время: ', time1_out - time1_in, ' секунд ', abs(time_out - time_in), ' милисекунд');
        readln;
        sort(n);
      end;
    2:
...
begin
  ...
  readln(n);
  assign(F_in, '1in.txt');
  assign(F_out, '1out.txt');
  assign(F_in1, '2in.txt');
  assign(F_out1, '2out.txt');
  writeln('Содержимое 1-го массива: ');
  rewrite(F_in);
  var a: char;
  for var i := 1 to n do
  begin
  ...
  rewrite(F_in1);
  writeln('Содержимое 2-го массива:');
  for var i := 1 to n do
  begin
    readln(a);
    write(F_in1, a);
